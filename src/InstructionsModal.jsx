  ...
  return (
    <div className="instructions-modal-overlay">
      <div className="modal-container">
        <h2 className="modal-title"><span className="modal-title-highlight">Scanne le logo sur le gobelet,</span> <br/> en plus de contenir une délicieuse boisson, il cache une experience en réalité augmentée.</h2>
